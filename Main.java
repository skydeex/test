	...
	static void merge(int[] A, int p, int q, int r) {
		...
		if(A[q] > A[q + 1]) {
			...
			if(A[p] >= A[r]) {
				...
				/**
				 * по-хорошему можно было искать значения деля правый отрезок пополам, и проверять, больше или меньше
				 * искомого, чтобы понять где опять делить (влево или вправо)
				 */
